...
# zsh tools and shortcuts
alias ohmyzsh="vim ~/.oh-my-zsh"
alias zshreload="source ~/.zshrc"
alias sync_dotfiles='bash ~/dotfiles/bootstrap.sh && zshreload'
alias dotfiles='cd ~/dotfiles'
alias zshconfig="vim ~/dotfiles/.zshrc"
alias vimconfig="vim ~/dotfiles/.vimrc"
alias gitconfig_global='vim ~/dotfiles/.gitconfig'
alias aliases="vim ~/dotfiles/.aliases"
alias extra="vim ~/dotfiles/.extra"
...
export ZSH=/Users/joachimmuth/.oh-my-zsh
...
# ADA cluster
#export YARN_CONF_DIR=~/Documents/EPFL/ADA/yarn/
#export HADOOP_USER_NAME=jmuth
